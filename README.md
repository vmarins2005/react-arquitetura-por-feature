...
o projeto [react-when-to-abstract](https://github.com/vmarins2005/react-when-to-abstract) discute. O gatilho para introduzir `entities` está
...
| `react-feature-architecture` **(você está aqui)** | Organizacao por feature em Next.js, com fronteiras garantidas por ESLint em vez de disciplina |
