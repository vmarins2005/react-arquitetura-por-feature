...
o projeto [react-quando-abstrair](https://github.com/vmarins2005/react-quando-abstrair) discute. O gatilho para introduzir `entities` está
...
| `react-arquitetura-por-feature` **(você está aqui)** | Organizacao por feature em Next.js, com fronteiras garantidas por ESLint em vez de disciplina |
