...
| FSD canônico completo | Vocabulário conhecido; escala para monorepo grande | Seis camadas com pouco conteúdo; `entities` vazia; cerimônia alta para time pequeno | Antecipação de estrutura — o mesmo erro do projeto [react-when-to-abstract](https://github.com/vmarins2005/react-when-to-abstract) |
